                            ...
                            <div class="col-xl-12 col-lg-7 col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="card-title">Permissions Master</h6>
                                    </div>
                                    <div class="card-body">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="4">
                                                                    <tr>
                                                                        <td width="46%" valign="top"><span class="style6">*</span>
                                                                            <b> <label id='lblcompanyname'>Permissions Name</label></b>
                                                                        <td width="54%" valign="top">
                                                                            <input type="text" value="" name="permissions_name" id="permissions_name" />
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card p-4 mb-4">
                    <h6 class="card-title mb-4">Permissions Master</h6>
