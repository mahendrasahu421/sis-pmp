                            ...
                            <div class="col-xl-12 col-lg-7 col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="card-title">Sub Menu Master</h6>
                                    </div>
                                    <div class="card-body">
                                                        ...
                                                        <td height="2" colspan="5" valign="top">
                                                            <div id="generaldetails" style="display:block;">
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="4">
                                                                    ...
                                                                    <tr>
                                                                        <td width="46%" valign="top"><span class="style6">*</span>
                                                                            <b> <label id='lblcompanyname'>Sub Menu Name</label></b>
                                                                        <td width="54%" valign="top">
                                                                            <input type="text" value="" name="sub_menu_name" id="sub_menu_name" />
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-12">
                <div class="card p-4 mb-4">
                    <h6 class="card-title mb-4">Sub Menu Master</h6>
                    ...
                    <table id="myTable" class="table display dataTable table-hover" style="width:100%">
                        ...
                        <tbody>
                            <tr class="even">
                                <td>4</td>
                                <!--<td></td>-->
                                <td>Submission Reports</td>
                                <td>submission_reports</td>

                                <td><span class="badge rounded-pill bg-success me-1 mb-1 mt-1">Active</span></td>
                                <td><a href="#" onclick="javascript:if(confirm('Do You Want to Edit Sub Menu ?')){return true;}else{return false}"><i class="fa fa-edit"></i></a></td>
                            </tr>
